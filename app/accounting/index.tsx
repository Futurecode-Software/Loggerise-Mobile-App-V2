    ...
    <View style={styles.container}>
      ...
      >
        ...
        <ModuleCard
          ...
          icon="wallet-outline"
          iconBg="#10b981"
          route="/accounting/cash-register"
        />
        ...
        <ModuleCard
          title="Çek"
          description="Alınan ve verilen çekler"
        ...
        <ModuleCard
          title="Senet"
          description="Alınan ve verilen senetler"
          icon="receipt-outline"
          iconBg="#8b5cf6"
          route="/accounting/promissory-note"
        />

        <ModuleCard
          title="İşlemler"
          description="Tüm mali işlemler"
