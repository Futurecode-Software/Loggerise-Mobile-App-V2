/**
 * Banka Hesabı Düzenleme Ekranı
 *
 * Modern tasarım - CLAUDE.md ilkelerine uygun
 * Referans: cash-register/[id]/edit.tsx
 */
...
export default function BankEditScreen() {
  ...
  // Banka verilerini yükle
  useEffect(() => {
    const loadBank = async () => {
      if (!id) {
        Toast.show({
          type: 'error',
          text1: 'Geçersiz banka hesabı ID',
          position: 'top',
          visibilityTime: 1500
        })
        setTimeout(() => {
      ...
      try {
        ...
        Toast.show({
          type: 'error',
          text1: 'Banka hesabı bilgileri yüklenemedi',
          position: 'top',
          visibilityTime: 1500
        })
        setTimeout(() => {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      Toast.show({
        type: 'success',
        text1: 'Banka hesabı başarıyla güncellendi',
        position: 'top',
        visibilityTime: 1500
      })
      router.back()
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.loadingContainer}>
          ...
          <Text style={styles.loadingText}>Banka hesabı bilgileri yükleniyor...</Text>
        </View>
      </View>
    )
  }
