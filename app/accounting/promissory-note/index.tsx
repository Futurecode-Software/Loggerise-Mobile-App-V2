...
const STATUS_FILTERS = [
  ...
  { id: 'protested', label: 'Protesto', icon: 'alert-circle-outline' as const },
...
// Skeleton Component
function PromissoryNoteCardSkeleton() {
  return (
...
function PromissoryNoteCard({ item, onPress }: PromissoryNoteCardProps) {
    ...
    >
      ...
      <View style={styles.cardHeader}>
        ...
        <View style={styles.cardHeaderContent}>
          <Text style={styles.cardName} numberOfLines={1}>{item.promissory_note_number}</Text>
          <Text style={styles.cardCode}>{item.contact?.name || '-'}</Text>
        </View>
        <View style={[styles.statusBadge, { backgroundColor: statusColors.bg }]}>
          <Text style={[styles.statusText, { color: statusColors.primary }]}>
            {getPromissoryNoteStatusLabel(item.status)}
          </Text>
        </View>
      </View>
...
function SummaryCard({ totalAmount, pendingAmount, clearedAmount, count }: SummaryCardProps) {
  return (
    <View style={styles.summaryCard}>
      <View style={styles.summaryHeader}>
        ...
        <Text style={styles.summaryCurrency}>Senet Özeti</Text>
      ...
      <View style={styles.summaryStats}>
        <View style={styles.summaryStat}>
          ...
          <Text style={styles.summaryStatValue}>{formatCurrency(clearedAmount, 'TRY')}</Text>
        ...
        <View style={styles.summaryStat}>
          ...
          <Text style={styles.summaryStatValue}>{formatCurrency(pendingAmount, 'TRY')}</Text>
...
function EmptyState() {
  return (
    <View style={styles.emptyState}>
      ...
      <Text style={styles.emptyTitle}>Henüz senet yok</Text>
      <Text style={styles.emptyText}>
        Yeni senet eklemek için sağ üstteki + butonuna tıklayın.
      </Text>
    </View>
  )
}
...
export default function PromissoryNotesScreen() {
  ...
  const handleCardPress = (item: PromissoryNote) => {
    Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light)
    router.push(`/accounting/promissory-note/${item.id}`)
  }

  const handleNewPress = () => {
    Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Medium)
    router.push('/accounting/promissory-note/new')
  }
