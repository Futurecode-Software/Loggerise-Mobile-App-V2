  ...
  return (
    <View style={styles.container}>
      ...
      >
        <ModuleCard
          title="Ürünler"
          description="Stok ürünleri ve fiyatları"
        ...
        <ModuleCard
          ...
          icon="grid-outline"
          iconBg="#8b5cf6"
          route="/inventory/stock/categories"
        />

        <ModuleCard
          title="Stok Hareketleri"
          description="Giriş ve çıkış hareketleri"
