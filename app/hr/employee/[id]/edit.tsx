 ...
 *
 * Çalışan düzenleme ekranı.
 * Backend UpdateEmployeeRequest validation kurallarına uyumlu.
 */
...
export default function EmployeeEditScreen() {
  ...
  useEffect(() => {
    const loadEmployee = async () => {
      ...
      try {
        ...
        Toast.show({
          type: 'error',
          text1: 'Çalışan bilgileri yüklenemedi',
          position: 'top',
          visibilityTime: 1500
        })
        setTimeout(() => {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      Toast.show({
        type: 'success',
        text1: 'Çalışan başarıyla güncellendi',
        position: 'top',
        visibilityTime: 1500
      })
      router.back()
    ...
    return (
      <View style={styles.container}>
          ...
          <View style={[styles.headerContent, { paddingTop: insets.top + 16 }]}>
            <View style={styles.headerBar}>
              ...
              <View style={styles.headerTitleContainer}>
                <Text style={styles.headerTitle}>Çalışan Düzenle</Text>
              </View>
        ...
        <View style={styles.loadingContainer}>
          ...
          <Text style={styles.loadingText}>Çalışan bilgileri yükleniyor...</Text>
        </View>
      </View>
    )
  }
