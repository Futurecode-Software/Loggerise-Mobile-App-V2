 ...
 *
 * Create new job posting (iş ilanı).
 */
...
export default function NewJobPostingScreen() {
  ...
  return (
    <View style={styles.container}>
      <FullScreenHeader
        title="Yeni İş İlanı"
        subtitle="İlan bilgilerini girin"
        rightIcons={
        ...
        >
          ...
          <Card variant="outlined" style={styles.card}>
            ...
            <Input
              ...
              onChangeText={(value) => handleInputChange('salary_min', value ? parseFloat(value) : undefined)}
              placeholder="0"
            ...
            <Input
              ...
              onChangeText={(value) => handleInputChange('salary_max', value ? parseFloat(value) : undefined)}
              placeholder="0"
              keyboardType="numeric"
