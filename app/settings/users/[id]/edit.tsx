 ...
 * Backend: PUT /settings/users/{id}
 *
 * CLAUDE.md standartlarına uygun:
 * - LinearGradient header with animated glow orbs
...
export default function UserEditScreen() {
  ...
  }, [orb1TranslateY, orb1Scale, orb2TranslateX, orb2Scale])
  ...
  const loadData = useCallback(async (showLoading = true) => {
    ...
    try {
      ...
      Toast.show({
        type: 'error',
        text1: 'Kullanıcı bilgileri yüklenemedi',
        position: 'top',
        visibilityTime: 1500
      })
      setTimeout(() => {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      Toast.show({
        type: 'success',
        text1: 'Kullanıcı başarıyla güncellendi',
        position: 'top',
        visibilityTime: 1500
      })
      router.back()
          ...
          <View style={[styles.headerContent, { paddingTop: insets.top + 16 }]}>
            <View style={styles.headerBar}>
              ...
              <View style={styles.headerTitleContainer}>
                <Text style={styles.headerTitle}>Kullanıcı Düzenle</Text>
              </View>
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <View style={styles.sectionIcon}>
              <Ionicons name="shield-checkmark-outline" size={18} color={DashboardColors.primary} />
            </View>
            ...
            {userId === 1 && (
              <View style={styles.warningBox}>
                ...
                <Text style={styles.warningText}>
                  İlk kullanıcının rolü değiştirilemez. Bu kullanıcı daima Süper Admin yetkilerine sahiptir.
                </Text>
              </View>
            )}
                ...
                >
                  <View
                    style={[
                      ...
                      userId === 1 && styles.checkboxDisabled
                    ]}
                  >
                  ...
                  <Text style={[
                    styles.roleText,
                    userId === 1 && styles.roleTextDisabled
                  ]}>
...
const styles = StyleSheet.create({
  ...
  warningBox: {
    ...
    backgroundColor: DashboardColors.warningGlow,
