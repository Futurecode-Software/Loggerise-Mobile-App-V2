    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={styles.container}>
        ...
        <View style={styles.contentArea}>
          {/* Group Name Input */}
          <View style={[styles.groupInputs, { backgroundColor: DashboardColors.surface }]}>
          ...
          {/* Create Group Button */}
          <View
            style={[styles.footer, { backgroundColor: DashboardColors.surface, borderTopColor: DashboardColors.borderLight }]}
          >
            <Button
