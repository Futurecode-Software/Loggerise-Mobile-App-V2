  ...
  const renderPositionCard = (position: Position) => {
    ...
    return (
      <TouchableOpacity
        key={position.id}
        activeOpacity={0.7}
        onPress={() => router.push(`/logistics/imports/positions/${position.id}` as any)}
      >
      ...
      <View style={styles.contentCard}>
        ...
        <View style={styles.statsGrid}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/logistics/imports/positions' as any)}
            activeOpacity={0.7}
          >
          ...
          <TouchableOpacity
            style={[styles.statCard, { backgroundColor: colors.card, borderColor: colors.border }]}
            onPress={() => router.push('/logistics/imports/disposition' as any)}
            activeOpacity={0.7}
          >
          ...
          <TouchableOpacity
            style={[styles.statCard, { backgroundColor: colors.card, borderColor: colors.border }]}
            onPress={() => router.push('/logistics/imports/loads' as any)}
            activeOpacity={0.7}
          >
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => router.push('/logistics/imports/positions' as any)}>
