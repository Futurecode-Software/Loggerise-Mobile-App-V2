/**
 * Promissory Notes List Screen (Placeholder)
 *
...
import { ChevronLeft, ScrollText, Construction } from 'lucide-react-native';
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        ...
        <Text style={[styles.headerTitle, { color: colors.text }]}>Senetler</Text>
      </View>

      <View style={styles.content}>
        <View style={[styles.iconContainer, { backgroundColor: `${Brand.primary}15` }]}>
          <ScrollText size={64} color={Brand.primary} />
        </View>
        ...
        <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
          Senet yönetimi modülü üzerinde çalışmalar devam ediyor. Kısa sürede kullanıma açılacaktır.
        </Text>
      </View>
    </SafeAreaView>
  );
